...
export default {
  ...
  'settings.ai.fallback.testSpeed': '测试镜像速度',
  'settings.ai.fallback.speedMirror': '镜像',
  'settings.ai.fallback.speedReachable': '状态',
  'settings.ai.fallback.speedOk': '正常',
  'settings.ai.fallback.speedFail': '失败',
  ...
  // v0.7.1
  'llm.models.fetch': '拉取模型',
  'llm.models.fetchHint': '当前没有支持「拉取模型」的供应商（需 openai_compat / anthropic / google）。配置供应商后即可一键拉取其模型目录入库。',
  'llm.models.fetchTitle': '拉取供应商模型目录',
  'llm.models.fetchEmpty': '该供应商返回了空列表，请检查 base_url 与 api_key。',
  'llm.models.alreadyExists': '状态',
  'llm.models.exists': '已存在',
  'llm.models.importSelected': '导入 {n} 个',
  'llm.models.importDone': '成功导入 {ok} 个，失败 {failed} 个',
  ...
  // v0.7.0
  'ai.chat.sessions.title': '会话',
  'ai.chat.sessions.new': '新建会话',
  'ai.chat.sessions.search': '搜索会话',
  'ai.chat.sessions.empty': '暂无会话，点击「新建会话」开始',
  'ai.chat.sessions.untitled': '(未命名)',
  'ai.chat.sessions.rename': '重命名',
  'ai.chat.sessions.msgs': '条消息',
  'ai.chat.sessions.archive': '归档',
  'ai.chat.sessions.unarchive': '取消归档',
  'ai.chat.sessions.showArchived': '显示已归档',
  'ai.chat.sessions.delete': '删除',
  'ai.chat.sessions.deleteConfirm': '删除该会话及其所有分支？此操作不可撤销。',
  'ai.chat.node.pathIndicator': '活动分支中 · {n} 条消息',
  'ai.chat.node.system': '系统',
  'ai.chat.node.streaming': '生成中…',
  'ai.chat.node.copy': '复制',
  'ai.chat.node.regenerate': '重新生成',
  'ai.chat.node.delete': '删除',
  'ai.chat.node.siblingNav': '分支 {n}/{total}',
  'ai.chat.export.title': '导出会话',
  'ai.chat.export.copy': '复制全文',
  'ai.chat.export.success': '已导出',
