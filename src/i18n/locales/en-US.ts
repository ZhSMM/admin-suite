...
export default {
  ...
  'settings.ai.fallback.testSpeed': 'Test mirror speed',
  'settings.ai.fallback.speedMirror': 'Mirror',
  'settings.ai.fallback.speedReachable': 'Status',
  'settings.ai.fallback.speedOk': 'OK',
  'settings.ai.fallback.speedFail': 'Failed',
  ...
  // v0.7.1
  'llm.models.fetch': 'Fetch models',
  'llm.models.fetchHint': 'No providers support model discovery yet (openai_compat / anthropic / google only). Configure a supported provider to seed its catalog in one click.',
  'llm.models.fetchTitle': 'Fetch provider model catalog',
  'llm.models.fetchEmpty': 'Provider returned no models — check base_url and api_key.',
  'llm.models.alreadyExists': 'Status',
  'llm.models.exists': 'Exists',
  'llm.models.importSelected': 'Import {n}',
  'llm.models.importDone': 'Imported {ok}, failed {failed}',
  ...
  'ai.chat.inputPlaceholder': 'Type a message and press Enter',
  'ai.chat.send': 'Send',
  'ai.chat.clear': 'Clear',
  'ai.chat.noProvidersTitle': 'No LLM providers configured',
  'ai.chat.noProvidersDesc': 'Add at least one provider (or install a local fallback) to start chatting.',
  'ai.chat.openSettings': 'Open LLM settings',
  // v0.7.0
  'ai.chat.sessions.title': 'Sessions',
  'ai.chat.sessions.new': 'New session',
  'ai.chat.sessions.search': 'Search sessions',
  'ai.chat.sessions.empty': 'No sessions yet. Click "New session" to start.',
  'ai.chat.sessions.untitled': '(untitled)',
  'ai.chat.sessions.rename': 'Rename',
  'ai.chat.sessions.msgs': 'msgs',
  'ai.chat.sessions.archive': 'Archive',
  'ai.chat.sessions.unarchive': 'Unarchive',
  'ai.chat.sessions.showArchived': 'Show archived',
  'ai.chat.sessions.delete': 'Delete',
  'ai.chat.sessions.deleteConfirm': 'Delete this session and all its branches? This cannot be undone.',
  'ai.chat.node.pathIndicator': 'Active branch · {n} messages',
  'ai.chat.node.system': 'System',
  'ai.chat.node.streaming': 'Generating…',
  'ai.chat.node.copy': 'Copy',
  'ai.chat.node.regenerate': 'Regenerate',
  'ai.chat.node.delete': 'Delete',
  'ai.chat.node.siblingNav': 'Branch {n}/{total}',
  'ai.chat.export.title': 'Export session',
  'ai.chat.export.copy': 'Copy full text',
  'ai.chat.export.success': 'Exported',
